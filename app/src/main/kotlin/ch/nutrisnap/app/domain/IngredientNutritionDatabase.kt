...
object IngredientNutritionDatabase {
    ...
    private val entries: Map<String, Entry> = mapOf(
        ...
        "kakaopulver"           to Entry(228f, 20f,  58f,  14f,  33f),
        "cacao"                 to Entry(228f, 20f,  58f,  14f,  33f),
        "cacao powder"          to Entry(228f, 20f,  58f,  14f,  33f),
        "cocoa"                 to Entry(228f, 20f,  58f,  14f,  33f),
        "cocoa powder"          to Entry(228f, 20f,  58f,  14f,  33f),
