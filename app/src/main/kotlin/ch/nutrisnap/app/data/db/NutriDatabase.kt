...
abstract class NutriDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        // IngredientMatch: manuelle Overrides persistent (amount/fiber/deleted)
        private val MIGRATION_31_32 = object : Migration(31, 32) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE ingredient_matches ADD COLUMN manualAmountG REAL DEFAULT NULL")
                db.execSQL("ALTER TABLE ingredient_matches ADD COLUMN manualFiberG REAL DEFAULT NULL")
                db.execSQL("ALTER TABLE ingredient_matches ADD COLUMN isDeleted INTEGER NOT NULL DEFAULT 0")
            }
        }
